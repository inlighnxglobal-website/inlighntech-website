...
const InternshipOnboardingModal = ({ isOpen, onClose }) => {
      ...
      <div className="bg-white rounded-[20px] shadow-2xl w-full max-w-[800px] overflow-hidden relative z-10 flex flex-col transform transition-all">
        ...
        <div className="px-8 py-8">
          <div className="mb-8">
            ...
            <div className="h-1 w-16 bg-[#6b38c9] mt-3 rounded-full"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2 md:w-[calc(50%-16px)]">
              <label className="block text-[13px] font-bold text-[#333] uppercase tracking-wide">
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative flex items-start pt-1">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-[18px] h-[18px] rounded-[4px] border-gray-300 text-[#6b38c9] focus:ring-[#6b38c9] cursor-pointer mt-0.5"
                  />
                </div>
