                  ...
                  >
                    ...
                    <div className="text-center my-6 sm:my-3 md:my-4 relative z-[2] px-2">
                      <p className="text-[#333333] text-base sm:text-xs md:text-sm my-2 sm:my-1 leading-relaxed">
                        <span className="font-semibold text-[#1e3a5f]">Duration:</span> {
                          isNaN(Number(verificationResult["Duration"]))
                            ? verificationResult["Duration"]
                            : `${verificationResult["Duration"]} ${Number(verificationResult["Duration"]) === 1 ? 'month' : 'months'}`
                        }
                      </p>
                      <p className="text-[#333333] text-base sm:text-xs md:text-sm my-2 sm:my-1 leading-relaxed">
