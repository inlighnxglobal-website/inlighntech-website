...
function WhatsSpecial() {
  ...
  // Intern Projects data
    const internProjects = [
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/Tablesdb.png',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/subdomain.png',
      ctaText: 'View Project',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/pdf-protector.png',
      ctaText: 'View Project',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/amazon-sales.png',
      ctaText: 'View Project',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/nova-ai.png',
      ctaText: 'View Project',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/python-program.png',
      ctaText: 'View Project',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/ai-interview.png',
      ctaText: 'View Project',
    ...
    },
    {
      ...
      image: 'https://chemical-violet-6kji7nsmss-taqm0l1kqy.edgeone.app/flipkart-sales.png',
      ctaText: 'View Project',
                  ...
                  <div className="flex flex-col lg:flex-row min-h-[450px]">
                    ...
                    <div className="lg:w-2/5 p-6 lg:p-8 flex flex-col justify-center">
                      ...
                      <div className="flex items-center justify-center lg:justify-start text-sm text-gray-600 pt-4 border-t border-gray-200">
                        ...
                        <span>Event Conducted by InLighnTech</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col lg:flex-row min-h-[450px]">
                    ...
                    <div className="lg:w-2/5 p-6 lg:p-8 flex items-center justify-center">
                      <div className="max-w-md">
                        ...
                        <div className="space-y-4 text-gray-600">
                          <p className="text-sm leading-relaxed">
                            Thrilled to announce that InlighnTech is proudly sponsoring Hack Summit 2025 at P.A. College of Engineering, Mangalore! 🚀 This 24-hour hackathon, powered by GD Edu Tech, is bringing together brilliant minds to innovate and collaborate. 💻
                          </p>
                          ...
                          <p className="text-sm leading-relaxed">
                            At InlighnTech, we're passionate about fostering innovation and empowering the next generation of tech leaders. Join us at Hack Summit 2025 to witness creativity in action! 💡
                          </p>
